...
if __name__ == '__main__':
    ...
    # Define your data paths
    TRAFFIC_DATA_PATH = r'C:\Users\Administrator\Desktop\Q1\Q1_IN_LAST\Q1_IN_LAST\hourly_flow_statistics.csv'
    WEATHER_DATA_DIR = r'C:\Users\Administrator\Desktop\Q1\Q1_IN_LAST\Q1_IN_LAST\DIV_OBCC(1)\DIV_OBCC'
    OUTPUT_DIR = r'C:\Users\Administrator\Desktop\Q1\Q1_IN_LAST\Q1_IN_LAST'
    ...
    if merged_data is not None:
        ...
        if len(X_train_encoder) > 0 and len(X_val_encoder) > 0:
            ...
            joblib.dump(scalers, scaler_path,protocol=4)
            print(f"Scalers saved to {scaler_path}")
